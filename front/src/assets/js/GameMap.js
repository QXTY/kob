...
export class GameMap extends GameObject {
    constructor(ctx, parent) {
        ...
        this.snakes = [
            new Snake({id: 0, color: "#48761C", r: this.rows - 2, c: 1},this),
    ...
    creat_walls() {
        ...
        const cory_g = JSON.parse(JSON.stringify(g));
        if (!this.check_connectivity(cory_g , this.rows - 2, 1, 1, this.cols - 2)) return false;
